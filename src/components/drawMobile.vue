<template>
  <div id = "app">
    ...
    <div id="canvas-area">
      <!-- スマホのときのキャンバス処理 -->
      <canvas id="Canvas" width = "350px" height = "350px" @touchstart="dragStart" @touchend="dragEnd" @touchmove="draw"  v-if="this.judgment" ></canvas>
      <!-- ボタンのCSS綺麗にして欲しいな -->
      <!--
      <button v-on:click = "keep">次へ</button>
      -->
